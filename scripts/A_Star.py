...
def GCfromList (gridMap, cellList):
	gridCells = GridCells()
...
def goalSearch (gridMap, start_pos, goal_pos):
	...
	while not frontier.empty():
		...
		if currNode not in visitedList:
			...
			frontiers = GCfromList(gridMap,frontierList)
			pub_frontier.publish(frontiers)
			visited = GCfromList(gridMap,visitedList)
			...
			for neighbor in GetNeighbors(currNode, gridMap):
